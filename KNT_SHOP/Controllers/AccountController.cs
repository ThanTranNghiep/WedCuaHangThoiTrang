...
namespace KNT_Shop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Name = model.Name, Rule = false, GioiTinh = getGender(model)};
        ...
        public void createCart(string id)
        {
            ...
            var user = db.GioHangs.FirstOrDefault(x=>x.Id == id);
            if (user == null)
            {
        ...
        public int getGender(RegisterViewModel model)
        {
            switch (model.Gender)
            {
                case "Male":
